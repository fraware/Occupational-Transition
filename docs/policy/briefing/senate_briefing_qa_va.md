...
Evidence: `docs/policy/briefing/senate_briefing_memo.md` non-claims section; `docs/paper/methods_data.md`.
...
Evidence: `docs/policy/briefing/senate_briefing_lineage_va.md`; `intermediate/state_deep_dive_qcew_51_run_metadata.json`; `intermediate/virginia_memo_kpis_run_metadata.json`.
...
Evidence: `docs/policy/briefing/senate_briefing_memo.md` federal action matrix; `docs/policy/claim_audit.md`.
...
Evidence: `docs/policy/briefing/senate_briefing_memo.md` (0-3 month horizon section).
...
Evidence: `figures/memo_btos_state_ai_use_latest.csv`; `figures/virginia_memo_kpis.csv`; `docs/quality/README.md#memo-visuals-t-101-to-t-108-precision-and-non-invention-rules`.
...
Evidence: `docs/policy/briefing/senate_briefing_memo.md` non-claims; `docs/paper/methods_data.md`.
...
Evidence: `docs/policy/briefing/senate_briefing_memo.md` 9-18 month action row; `figures/figure4_panelA_jolts_sector_rates.csv`; `figures/figure4_panelB_ces_sector_index.csv`.
