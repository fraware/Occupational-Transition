...
`intermediate/*_run_metadata.json` (see `docs/policy/briefing/senate_briefing_evidence_baseline_va.md`).
...
|---------|----------------|-----------------|-----------------|---------------------|
| 0-3 months | Finalize CPS AI module wording, BTOS core-item stability language, and publication metadata standards. | `va01`-`va06`; `figures/virginia_memo_kpis.csv`; `docs/quality/README.md#memo-visuals-t-101-to-t-108-precision-and-non-invention-rules` | Immediate improvement in comparability and transparency of public monitoring outputs. | Interagency coordination lag and scope creep in module design. |
