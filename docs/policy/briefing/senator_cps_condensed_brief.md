...
- Transition probabilities are normalized and QA-checked in `docs/methodology/tickets/t005_figure2_panelB_probs_methodology.md` and `intermediate/figure2_panelB_probs_run_metadata.json`.
- Independent supplement evidence (displacement, tenure, mobility) is integrated in `figures/figureA3_cps_supp_validation.csv` with methods in `docs/methodology/tickets/t013_figureA3_cps_supp_validation_methodology.md`.
...
This is consistent with guardrails in `docs/paper/methods_data.md` and `docs/policy/briefing/senate_briefing_memo.md`.
...
- `docs/paper/methods_data.md`
- `docs/methodology/tickets/t005_figure2_panelB_probs_methodology.md`
- `docs/methodology/tickets/t013_figureA3_cps_supp_validation_methodology.md`
