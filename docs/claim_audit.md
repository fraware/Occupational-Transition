...
| **5** — Main gap is lack of a public integrated worker–firm AI panel; extend existing surveys | Figure 5 (capability matrix) | **Supported partially** | `figures/figure5_capability_matrix.csv`; `docs/figure_memos/fig05.md` | Matrix is documentation-based synthesis, not an estimator; supports architecture argument when paired with narrative limits from Claims 1–4. |
