...
- Full narrative: `docs/senate_briefing_memo.md`
- One-page handout: `docs/senator_handout_1page_va.md`
- Print and briefing sequence: `docs/senator_packet_order_va.md`
- Lineage appendix: `docs/senate_briefing_lineage_va.md`
- Spoken script and Q&A: `docs/senate_briefing_script_va.md`, `docs/senate_briefing_qa_va.md`
- Claim audit rows: `docs/claim_audit.md` (Senator brief claim ledger)
