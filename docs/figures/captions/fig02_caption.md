...
**Interpretation.** The figure shows that the frozen occupation-based grouping used throughout the paper is behaviorally salient in worker-side public data, not merely a task-taxonomy imposed for convenience.

**Boundary.** These are descriptive worker-side constructs from public-use CPS data. The figure does not identify employer AI adoption, worker-firm linkage, or causal treatment effects.
