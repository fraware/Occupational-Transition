...
| Figure 6 | Policy roadmap from observability frontier | `figures/figure6_policy_roadmap.csv` | `policy_roadmap` |
...
| Figure 6 | `docs/figures/captions/fig06_caption.md` | `docs/figures/source_notes/fig06_sources.md` |
