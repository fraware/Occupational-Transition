...
- Ticket methodology doc `docs/methodology/tickets/t*_methodology.md` for interpretation
...
- Substantive claims in the manuscript match the resolution limits in each `docs/methodology/tickets/t*_methodology.md`.
