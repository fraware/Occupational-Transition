...
Visual stems: `t011`–`t020` per [quality README — Visual style guide](../quality/README.md#visual-style-guide) and [figure catalog](../figures/figure_catalog.md) (appendix subsection to be added if needed).
