"""Ticket QA (from scripts/qa_figureA8_lehd_benchmark.py)."""
...
def main() -> int:
    ...
    try:
        df["benchmark_rate"] = pd.to_numeric(df["benchmark_rate"], errors="raise")
    ...
    if meta.get("benchmark_series_label") != df["benchmark_series_label"].iloc[0]:
