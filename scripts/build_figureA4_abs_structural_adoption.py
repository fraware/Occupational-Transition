...
RAW_DIR = ROOT / "raw" / "abs"
FIG_DIR = ROOT / "figures"
INTER_DIR = ROOT / "intermediate"

OUT_CSV = FIG_DIR / "figureA4_abs_structural_adoption.csv"
OUT_META = INTER_DIR / "figureA4_abs_structural_adoption_run_metadata.json"
...
def main() -> None:
    ...
    raw_json_path = RAW_DIR / "abstcb_2018_us_national.json"
    ...
    meta = {
        ...
        "downloaded_artifacts": [
            {
                "path": str(raw_json_path.relative_to(ROOT)),
