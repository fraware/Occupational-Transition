"""
Build figures/figure4_panelB_ces_sector_index.csv from official BLS LABSTAT CES
national seasonally adjusted all-employees payroll employment (thousands).

Run from repo root: python scripts/build_figure4_panelB_ces_sector_index.py
"""
