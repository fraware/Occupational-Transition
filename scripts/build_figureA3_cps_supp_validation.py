...
def load_occ22_mapping() -> dict[int, int]:
    """
...
def load_tercile_mapping() -> dict[int, str]:
...
def main() -> None:
    ...
    # Download/cache data.
    jan24_csv_path = RAW / "jan24pub.csv"
    jan24_pdf_path = RAW / "cpsjan24.pdf"
    ...
    occ22_map = load_occ22_mapping()
    tercile_by_occ22 = load_tercile_mapping()
