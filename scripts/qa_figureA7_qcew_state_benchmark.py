"""QA for T-017 Figure A7 QCEW state benchmark."""
...
META_JSON = ROOT / "intermediate" / "figureA7_qcew_state_benchmark_run_metadata.json"
...
def main() -> int:
    ...
    sum_df = df.groupby("state_fips", as_index=False)["state_sector_employment_share"].sum()
